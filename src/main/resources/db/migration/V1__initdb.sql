...
ALTER TABLE j_mentor
    ADD CONSTRAINT FK_J_MENTOR_ON_ID FOREIGN KEY (id) REFERENCES j_user (id);

ALTER TABLE j_student
    ADD CONSTRAINT FK_J_STUDENT_ON_ID FOREIGN KEY (id) REFERENCES j_user (id);

ALTER TABLE j_ta
    ADD CONSTRAINT FK_J_TA_ON_ID FOREIGN KEY (id) REFERENCES j_user (id);
